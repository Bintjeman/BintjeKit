...
namespace bnjkit::ecs {
    ...
    template<typename SystemType, typename PriorityType>
    bool SystemManager<SystemType, PriorityType>::remove_system(
    ...
    template<typename SystemType, typename PriorityType>
    void SystemManager<SystemType, PriorityType>::toggle_system(
        const std::string& name,
        bool enable
    ) {
    ...
    template<typename SystemType, typename PriorityType>
    SystemType& SystemManager<SystemType, PriorityType>::system(
        const std::string& name
    ) {
        auto index = m_system_registry[name];
    ...
    template<typename SystemType, typename PriorityType>
    const SystemType& SystemManager<SystemType,
