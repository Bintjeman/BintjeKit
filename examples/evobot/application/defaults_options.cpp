...
namespace evo {
    namespace app {
        namespace opt {
            std::map<opt::EnumOptions, opt::Option> Option::register_options;
            std::map<char, opt::EnumOptions> Option::register_options_short;
            std::map<std::string_view, opt::EnumOptions> Option::register_options_long;
            ...
            void Option::make_options() {
                add_option({'d', "debug", "Debug mode", EnumOptions::DEBUG});
                add_option({'c', "clion", "From clion", EnumOptions::CLION});
                add_option({'w', "workdir", "Choose workdir", EnumOptions::WORKDIR});
            }
